...
export class UpdateInductionClass1629689989567 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "schema" = $2 AND "name" = $3`, ["VIEW", "public", "events_view"]);
        await queryRunner.query(`DROP VIEW "events_view" CASCADE`);
        await queryRunner.query(`DELETE FROM "typeorm_metadata" WHERE "type" = $1 AND "schema" = $2 AND "name" = $3`, ["VIEW", "public", "inductee_points_view"]);
        await queryRunner.query(`ALTER TABLE "event_hosts_app_user" DROP CONSTRAINT "FK_a62ab1e0e22487c58afd071c20c"`);
        await queryRunner.query(`ALTER TABLE "event_hosts_app_user" DROP CONSTRAINT "FK_ae61de7bcb59f2b82c4218c9e71"`);
        ...
        await queryRunner.query(`ALTER TABLE "event_hosts_app_user" ADD CONSTRAINT "FK_ae61de7bcb59f2b82c4218c9e71" FOREIGN KEY ("eventId") REFERENCES "event"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "event_hosts_app_user" ADD CONSTRAINT "FK_a62ab1e0e22487c58afd071c20c" FOREIGN KEY ("appUserId") REFERENCES "app_user"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "event_hosts_app_user" ADD CONSTRAINT "FK_ae61de7bcb59f2b82c4218c9e71" FOREIGN KEY ("eventId") REFERENCES "event"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "event_hosts_app_user" ADD CONSTRAINT "FK_a62ab1e0e22487c58afd071c20c" FOREIGN KEY ("appUserId") REFERENCES "app_user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);

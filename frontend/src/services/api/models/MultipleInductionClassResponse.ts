...
export function MultipleInductionClassResponseFromJSON(
  json: any
): MultipleInductionClassResponse {
  return MultipleInductionClassResponseFromJSONTyped(json, false);
}

export function MultipleInductionClassResponseFromJSONTyped(
  json: any,
  ...
  return {
    inductionClasses: (json['inductionClasses'] as Array<any>).map(
      InductionClassResponseFromJSON
    ),
  };
}

export function MultipleInductionClassResponseToJSON(
  value?: MultipleInductionClassResponse | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    inductionClasses: (value.inductionClasses as Array<any>).map(
      InductionClassResponseToJSON
    ),
  };
}

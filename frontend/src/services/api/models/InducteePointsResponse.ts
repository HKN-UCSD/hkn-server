...
export function InducteePointsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InducteePointsResponse {
...
export function InducteePointsResponseToJSON(value?: InducteePointsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {

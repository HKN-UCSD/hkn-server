...
export function InductionClassResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InductionClassResponse {
...
export function InductionClassResponseToJSON(value?: InductionClassResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {

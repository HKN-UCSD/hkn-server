...
export function AppUserResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): AppUserResponse {
    ...
    return {
        ...
        'role': json['role'],
        'availabilities': !exists(json, 'availabilities') ? undefined : ((json['availabilities'] as Array<any>).map(AppUserInterviewAvailabilityFromJSON)),
    };
}
...
export function AppUserResponseToJSON(value?: AppUserResponse | null): any {
    ...
    return {
        ...
        'role': value.role,
        'availabilities': value.availabilities === undefined ? undefined : ((value.availabilities as Array<any>).map(AppUserInterviewAvailabilityToJSON)),
    };
}

...
export class AddPointsToAttendance1602396781946 implements MigrationInterface {
  name = 'AddPointsToAttendance1602396781946';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "attendance" ADD "points" integer NOT NULL`);
    await queryRunner.query(
